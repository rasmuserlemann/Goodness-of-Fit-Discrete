...
# DISTRIBUTIONS, SIMULATION, ESTIMATION


# BETA-GEOMETRIC DISTRIBUTION - shape1 and 2 are alpha and # beta in the paper
...
# ESTIMATION IN BETA-GEOMETRIC AND GEOMETRIC - EXAMPLE

# NOT RUN {
# }


# ESTIMATION IN DISCRETE WEIBULL TYPE I


# zero=TRUE if 0 is a possible value, otherwise zero=FALSE # (default)
...
# THIS IS THE SCORE TEST FOR THE BETA-BINOMIAL 
...
# THIS IS THE PREFERRED SCORE TEST FOR THE BETA-BINOMIAL.
...
# THIS IS THE MOMENT ESTIMATOR FOR THETA IN THE BETA-BINOMIAL
...
#Quantiles
print(sort(test1)[as.integer(L*0.95)])
print(sort(test2)[as.integer(L*0.95)])
print(sort(condtest1)[as.integer(L*0.95)])
print(sort(condtest2)[as.integer(L*0.95)])

d = c(rnorm(30, 0, 1), rnorm(70,0,5))
plot(d, type="l", ylab="")
